...
describe('learning recommendations', () => {
    ...
    it('prefers inline recommendation compute for local WebKit development', () => {
        ...
        expect(shouldPreferInlineRecommendationsWorker({
            isDev: true,
            userAgent: 'Mozilla/5.0 (iPhone; CPU iPhone OS 18_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/142.0.0.0 Mobile/15E148 Safari/604.1',
        })).toBe(true);
        expect(shouldPreferInlineRecommendationsWorker({
            isDev: true,
            userAgent: 'Mozilla/5.0 (iPhone; CPU iPhone OS 18_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) EdgiOS/142.0.0 Mobile/15E148 Safari/605.1.15',
        })).toBe(true);
    });
