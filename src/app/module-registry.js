...
export const MODULE_LOADERS = {
    ...
    songPlayer: () => import('../songs/song-player.js'),
    ...
    curriculumRuntime: () => import('../curriculum/runtime.js'),
...
const MODULE_RULES = [
    { when: equals('view-tuner'), modules: ['tuner'] },
    {
        ...
        modules: ['realtimeSession', 'missionProgress', 'curriculumRuntime'],
    },
    { when: equals('view-session-review', 'view-analysis'), modules: ['sessionReview', 'recordings'] },
    { when: oneOf(equals('view-songs'), startsWith('view-song-')), modules: ['songProgress', 'songPlayer', 'songSearch', 'recordings'] },
    { when: equals('view-onboarding'), modules: ['onboarding'] },
    { when: equals('view-coach'), modules: ['coachActions', 'focusTimer', 'lessonPlan', 'missionProgress', 'recommendationsUi'] },
