...
export class GameTimer {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        GameTimerFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_gametimer_free(ptr, 0);
    }
    /**
     * @returns {number}
     */
    get bpm() {
        const ret = wasm.gametimer_bpm(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     */
    get_beat(timestamp) {
        const ret = wasm.gametimer_get_beat(this.__wbg_ptr, timestamp);
        return ret;
    }
    /**
     * @returns {number}
     */
    get ms_per_beat() {
        const ret = wasm.gametimer_ms_per_beat(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} bpm
     */
    constructor(bpm) {
        const ret = wasm.gametimer_new(bpm);
        this.__wbg_ptr = ret >>> 0;
        GameTimerFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     * @param {number} timestamp
     * @param {number} target_beat
     * @returns {number}
     */
    score_tap(timestamp, target_beat) {
        const ret = wasm.gametimer_score_tap(this.__wbg_ptr, timestamp, target_beat);
        return ret;
    }
    /**
     ...
     */
    set_bpm(bpm) {
        wasm.gametimer_set_bpm(this.__wbg_ptr, bpm);
    }
    /**
     * Start the timer
     * @param {number} timestamp
     */
    start(timestamp) {
        wasm.gametimer_start(this.__wbg_ptr, timestamp);
    }
}
if (Symbol.dispose) GameTimer.prototype[Symbol.dispose] = GameTimer.prototype.free;
...
export class SkillProfile {
     ...
     * @param {number} minutes
     */
    apply_practice_event(event_id, minutes) {
        const ptr0 = passStringToWasm0(event_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.skillprofile_apply_practice_event(this.__wbg_ptr, ptr0, len0, minutes);
    }
    /**
     * @returns {number}
     */
...
export class XpRewards {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        XpRewardsFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_xprewards_free(ptr, 0);
    }
    /**
     ...
     */
    get game_perfect() {
        const ret = wasm.__wbg_get_xprewards_game_perfect(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    get per_minute() {
        const ret = wasm.__wbg_get_xprewards_per_minute(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    get song_complete() {
        const ret = wasm.__wbg_get_xprewards_song_complete(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     * @returns {number}
     */
    get streak_multiplier() {
        const ret = wasm.__wbg_get_xprewards_streak_multiplier(this.__wbg_ptr);
        return ret;
    }
    /**
     * Bonus for perfect score in a game
     * @param {number} arg0
     */
    set game_perfect(arg0) {
        wasm.__wbg_set_xprewards_game_perfect(this.__wbg_ptr, arg0);
    }
    /**
     * Base XP per minute of practice
     * @param {number} arg0
     */
    set per_minute(arg0) {
        wasm.__wbg_set_xprewards_per_minute(this.__wbg_ptr, arg0);
    }
    /**
     * Bonus for completing a song
     * @param {number} arg0
     */
    set song_complete(arg0) {
        wasm.__wbg_set_xprewards_song_complete(this.__wbg_ptr, arg0);
    }
    /**
     * Multiplier for streak days
     * @param {number} arg0
     */
    set streak_multiplier(arg0) {
        wasm.__wbg_set_xprewards_streak_multiplier(this.__wbg_ptr, arg0);
    }
}
if (Symbol.dispose) XpRewards.prototype[Symbol.dispose] = XpRewards.prototype.free;

/**
 * Calculate adaptive difficulty based on recent scores
 * @param {Uint8Array} recent_scores
 * @returns {number}
 */
export function calculate_difficulty(recent_scores) {
    const ptr0 = passArray8ToWasm0(recent_scores, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.calculate_difficulty(ptr0, len0);
    return ret;
}
...
/**
 * @param {any} adaptive_log
 * @param {any} song_events
 * @returns {any}
 */
export function compute_recommendation_seed(adaptive_log, song_events) {
    const ret = wasm.compute_recommendation_seed(adaptive_log, song_events);
    if (ret[2]) {
...
const GameTimerFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_gametimer_free(ptr >>> 0, 1));
...
const XpRewardsFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_xprewards_free(ptr >>> 0, 1));
