 ...
 */
export function CanvasGameRunner({ gameId, bindCanvasEngine, onFinish, children }) {
    ...
    }, [bindCanvasEngine, gameId]);

    return (
        <div ref={containerRef} id={`view-game-${gameId}`} style={{ width: '100%', height: '100%', position: 'absolute', inset: 0, overflow: 'hidden', backgroundColor: '#000' }}>
