...
const BADGE_META = {
    ...
    streak_7: { name: 'Week Warrior', artSrc: getPublicAssetPath('./assets/badges/badge_practice_streak_1769390952199.webp') },
    level_5: { name: 'Rising Star', artSrc: null },
    practice_100: { name: 'Dedicated', artSrc: null },
    pitch_perfect: { name: 'Pitch Perfect', artSrc: getPublicAssetPath('./assets/badges/badge_pitch_master_1769390924763.webp') },
    rhythm_master: { name: 'Rhythm Master', artSrc: getPublicAssetPath('./assets/badges/badge_rhythm_star_1769390938421.webp') },
    bow_hero: { name: 'Bow Hero', artSrc: getPublicAssetPath('./assets/badges/badge_bow_hero_1769390964607.webp') },
    ear_training: { name: 'Golden Ear', artSrc: getPublicAssetPath('./assets/badges/badge_ear_training_1769391019017.webp') },
