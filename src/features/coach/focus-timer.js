...
const ensureBadge = () => ensureDifficultyBadge(document.querySelector('.coach-card-header'));
...
const startSession = () => {
    ...
    updateCountdown();
    stopTicker = registerUiTicker(updateCountdown);
};
...
const stopWhenInactive = (viewIdOverride = null) => {
...
onViewChange((viewId) => stopWhenInactive(viewId));
